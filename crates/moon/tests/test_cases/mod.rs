...
fn test_extra_flags() {
    ...
    check(
        ...
        expect![[r#"
            moonc build-package ./lib/hello.mbt -o ./target/wasm-gc/debug/build/lib/lib.core -pkg hello/lib -pkg-sources hello/lib:./lib -target wasm-gc -g -O0 -source-map -g -no-builtin
            moonc build-package ./main/main.mbt -o ./target/wasm-gc/debug/build/main/main.core -pkg hello/main -is-main -i ./target/wasm-gc/debug/build/lib/lib.mi:lib -pkg-sources hello/main:./main -target wasm-gc -g -O0 -source-map -g -no-builtin
    ...
    // test
    {
        check(
            ...
            expect![[r#"
                ...
                cc ./target/native/release/test/lib/lib.whitebox_test.c -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing -lm -o ./target/native/release/test/lib/lib.whitebox_test.exe
                ...
                cc ./target/native/release/test/lib/lib.internal_test.c -I$MOON_HOME/include -O2 $MOON_HOME/lib/libmoonbitrun.o -fwrapv -fno-strict-aliasing -lm -o ./target/native/release/test/lib/lib.internal_test.exe
            "#]],
        );
        check(
            get_stdout(
...
fn test_render_diagnostic_in_patch_file() {
    ...
    // check --explain
    check(
        get_stderr(&dir, ["check", "lib", "--patch-file", "./patch_test.json", "--explain"]),
        expect![[r#"
            Warning: [1002]
            # E1002
